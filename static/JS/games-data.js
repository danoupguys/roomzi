    ...
    gamesDataToggles.addEventListener("click", (e) => {
        if (e.target.tagName === "LI") {
            ...
            toggles.forEach((toggle) => {
                if (toggle === e.target) toggle.className = "mx-3 cursor-pointer border-b-2 border-b-inherit drop-shadow-[0_0_3px_#F00] pb-1 md:pb-3 hover:drop-shadow-[0_0_3px_#F00] hover:border-b-inherit";
                else toggle.className = "mx-3 cursor-pointer border-b-2 border-b-transparent pb-1 md:pb-3 hover:drop-shadow-[0_0_3px_#F00] hover:border-b-inherit";
            });
